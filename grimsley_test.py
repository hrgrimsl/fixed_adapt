...
#ansatz = np.load("h6_grimsley/ops.npy")
#params = np.load("h6_grimsley/params.npy")
xiphos = Xiphos(H, ref, "h6_grimsley", pool, v_pool, sym_ops = {"H": H, "S_z": Sz, "S^2": S2, "N": Nop}, verbose = "DEBUG")
params, ansatz = xiphos.rebuild_ansatz(86)
xiphos.adapt(params, ansatz, ref, Etol = 1e-12)
