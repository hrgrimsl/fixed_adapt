...
plt.vlines(31, 0, 1, color = "black", label = "Last new operator before ansatz is repeated.")
plt.legend()

plt.xlabel("ADAPT Iterations")
plt.ylabel("Error From ED (a.u.)")
plt.yscale("symlog", linthresh = 1e-10)
plt.title("qubit-ADAPT-VQE on H$_4$")
plt.show()
...
plt.vlines(31, 0, 31, color = "black", label = "Last new operator before ansatz is repeated.")
plt.xlabel("ADAPT Iterations")
