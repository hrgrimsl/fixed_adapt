if __name__ == '__main__':
    ...
    xiphos = Xiphos(H, ref, "h6_3A_15_3", pool, v_pool, sym_ops = {"H": H, "S_z": Sz, "S^2": S2, "N": Nop}, verbose = "DEBUG")
    np.random.seed(3)
    params = math.pi*2*np.random.rand(15)
    ansatz = list(np.load("h6_3A_adapt/bre_ops.npy")[-15:])
    xiphos.adapt(params, ansatz, ref, max_depth = 54, guesses = 0)
