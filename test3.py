...
E, zero_params = uccsd_adapt(H, ref, N_e, N_qubits, S2, factor = Eh, thresh = 1e-3, spin_adapt =  True, out_file = 'diss', depth = 20)
...
for i in range(10, 46):
    ...
    N_e -= N_c
    H, ref, N_qubits, S2 = of_from_arrays(E_nuc, H, I, N_e)
    E, params = fixed_fermionic(H, ref, N_e, N_qubits, params, factor = Eh, in_file = 'diss')
