...
#E, zero_params = qubit_adapt(H, ref, N_e, N_qubits, S2, factor = Eh, thresh = 5e-5, out_file = 'cfb.dat')
zero_params = np.zeros(32)
params1 = copy.copy(zero_params)
params2 = copy.copy(zero_params)
print("Fixed ADAPT:")
print("Scanning backward...")
for r in reversed(range(10,26)): 
    geometry = """
    0 1
    H 0 0 0
    """
    ...
    H, ref, N_qubits, S2 = of_from_arrays(E_nuc, H, I, N_e, S_squared = 0, S_z = 0)
    E, params1 = fixed_adapt(H, ref, N_e, N_qubits, params1, factor = Eh, in_file = 'cfb.dat')
...
for r in range(26,46): 
    ...
    H, ref, N_qubits, S2 = of_from_arrays(E_nuc, H, I, N_e, S_squared = 0, S_z = 0)
    E, params2 = fixed_adapt(H, ref, N_e, N_qubits, params2, factor = Eh, in_file = 'cfb.dat')
